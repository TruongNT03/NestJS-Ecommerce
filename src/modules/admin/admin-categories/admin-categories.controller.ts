...
export class AdminCategoriesController {
  ...
  @RolePermission({ module: ModuleEnum.CATEGORY, permission: ActionPermission.CREATE })
  ...
  @RolePermission({ module: ModuleEnum.CATEGORY, permission: ActionPermission.READ })
  @ApiOperation({ summary: '[ADMIN] GET LIST CATEGORIES' })
  @ApiResponse({ type: ListCategoryResponseDto })
  @Get('')
  async findAll(@Query() query: ListCategoryQueryDto): Promise<ListCategoryResponseDto> {
